...
const [allGoblins, setAllGoblins] = useState(['goblin-one']);
...
const [goblinFormColor, setGoblinFormColor] = useState('red');
  ...
  function submitGoblin(e) {
    ...
    allGoblins([...allGoblins, newGoblin])
  ...
  return (
    <div className="App">
      <div className='current-goblin quarter'>
        <Goblin goblin={{ goblinFormName, goblinFormHP, goblinFormColor
          /* 
      ...
      <GoblinForm 
        ...
        Here is the list of props to pass:
          ...
          setGoblinFormHP,
        */
          submitGoblin={submitGoblin} goblinFormName= {goblinFormName} setGoblinFormName= {setGoblinFormName} goblinFormColor={goblinFormColor}
          goblinFormHP={goblinFormHP} setGoblinFormHP={setGoblinFormHP}
      />

      <GoblinList 
        goblins={
          if (filteredGoblins.length > 0) {
